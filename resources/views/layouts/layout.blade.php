  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
        ...
        <div class="sidebar-brand-text mx-2">Pemrograman Akuntansi I</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item fas fa-arrow-circle-right" href="/akun"> akun</a>
            <a class="collapse-item fas fa-arrow-circle-right" href="/kaskeluar"> kas keluar</a>
            <a class="collapse-item fas fa-arrow-circle-right" href="/bukubesar"> buku besar</a>
            <a class="collapse-item fas fa-arrow-circle-right" href="/kasmasuk"> kas masuk</a>
            <a class="collapse-item fas fa-arrow-circle-right" href="/user"> user </a>
          </div>
        </div>
      </li>
      <li class="nav-item">
